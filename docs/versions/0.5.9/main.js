...
var PersonaPanel = class extends BasePanel {
  ...
  async performAnalysis(container, button) {
    const { MarkdownView: MarkdownView2, Notice, TFile: TFile2 } = require("obsidian");
...
// src/main.ts
var SmartWriteCompanionPlugin = class extends import_obsidian5.Plugin {
  async onload() {
    ...
    this.registerEvent(
      this.app.workspace.on("editor-change", (0, import_obsidian5.debounce)((editor, view) => {
