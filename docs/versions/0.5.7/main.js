...
var SmartWriteSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Ollama Model").setDesc("The model to use for analysis (e.g., qwen2.5:0.5b, phi3, llama3.2)").addText((text) => text.setPlaceholder("qwen2.5:0.5b").setValue(this.plugin.settings.ollamaModel).onChange(async (value) => {
...
var PersonaPanel = class extends BasePanel {
  ...
  async performAnalysis(container, button) {
    ...
    if (resultsContainer) {
      ...
      loading.setText("\u{1F914} Thinking...");
    }
    try {
