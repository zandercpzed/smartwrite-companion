...
var PersonaPanel = class extends BasePanel {
  ...
  renderSetupGuide(container) {
    ...
    step2.createDiv({ cls: "smartwrite-suggestion-description", attr: { style: "font-size: 12px;" } }).setText("Open the downloaded file and drag Ollama to Applications");
    ...
    step3.createDiv({ cls: "smartwrite-suggestion-description", attr: { style: "font-size: 12px;" } }).setText("Open Ollama.app from Applications folder");
    ...
    infoBox.createEl("strong", { text: "\u{1F4A1} No Terminal Required!" });
    infoBox.createEl("br");
